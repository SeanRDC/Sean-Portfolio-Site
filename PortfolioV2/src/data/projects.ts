...
const violetRose = "radial-gradient(70% 80% at 35% 25%, rgba(255,111,165,0.6), transparent 60%), radial-gradient(60% 70% at 82% 80%, rgba(123,92,255,0.5), transparent 60%), #14141f";
const roseCyan = "radial-gradient(70% 80% at 40% 30%, rgba(255,111,165,0.55), transparent 60%), radial-gradient(60% 70% at 80% 80%, rgba(79,210,255,0.5), transparent 60%), #14141f";
const violetCyan = "radial-gradient(70% 80% at 35% 25%, rgba(123,92,255,0.6), transparent 60%), radial-gradient(60% 70% at 80% 80%, rgba(79,210,255,0.55), transparent 60%), #14141f";
const cyanRose = "radial-gradient(70% 80% at 40% 30%, rgba(79,210,255,0.55), transparent 60%), radial-gradient(60% 70% at 80% 80%, rgba(255,111,165,0.5), transparent 60%), #14141f";

const alt1 = "radial-gradient(80% 90% at 70% 20%, rgba(123,92,255,0.45), transparent 60%), #0f0f18";
const alt2 = "radial-gradient(80% 90% at 25% 75%, rgba(79,210,255,0.42), transparent 60%), #0f0f18";
...
export const projects: ProjectDetail[] = [
  {
    ...
    features: ["Editorial lookbook gallery", "Bead-by-bead product detail", "Wishlist & save", "Frictionless cart"],
    goals: ["Make handmade feel premium", "Center the photography", "Reduce steps to purchase"],
    achievements: ["+38% session duration", "Sold-out first drop", "Fully responsive build"],
  },
  {
    id: "flower-catalogue",
    ...
    features: ["Seasonal collections", "Arrangement detail view", "Care-guide tooltips", "Inquiry-to-order flow"],
    goals: ["Calm, gallery-like browsing", "Highlight seasonality", "Make ordering feel effortless"],
    achievements: ["2× catalogue engagement", "Cleaner ordering funnel", "Brand-defining visual system"],
  },
  {
    id: "pixel-ecommerce",
    ...
    features: ["Faceted search & filters", "Instant preview", "License selection", "Creator dashboards"],
    goals: ["Designer-grade polish", "Fast discovery at scale", "Clear licensing"],
    achievements: ["Scaled to 300+ listings", "Sub-second search", "Reusable design system"],
  },
  {
    id: "debut-invitation",
    ...
    features: ["Scroll-told narrative", "Event detail reveals", "Animated RSVP", "Add-to-calendar"],
    goals: ["Make it feel like an event", "Effortless RSVP", "Memorable first impression"],
    achievements: ["94% RSVP completion", "Shared widely by guests", "Bespoke motion design"],
  },
];
